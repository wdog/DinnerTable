{{--
    Calendario Disponibilità di Gruppo - Vista Mensile
    ...
    Struttura:
    1. Header con toggle vista e navigazione mensile
                ...
                @foreach ($calendarData as $dateInfo)
                    ...
                    @else
                        ...
                        <div @class([
                            ...
                            {{-- Header giorno --}}
                            <div
                                class="space-x-2 border-b pb-2 mb-2 border-gray-300 dark:border-gray-600
                                flex items-center justify-start text-md font-bold text-custom-600 dark:text-gray-400">

                                <div>
                                    {{ $dateInfo['day'] }}
                                </div>

                                <div class="text-xs text-slate-500 dark:text-lime-500  ">
                                                ...
                                                @if ($canHost && isset($availability['max_guests']))
                                                    <div class="text-xs flex items-center gap-1">
                                                        ...
                                                        <span>
                                                            ...
                                                            @else
                                                                <span
                                                                    class="font-semibold text-orange-500">(PIENO)</span>
                                                            @endif
                                                        </span>
                                                    </div>
                                                    <div class="text-xs font-semibold ml-5">
                                                    ...
                                                    @if (isset($dateInfo['user_booking']) && $dateInfo['user_booking'] && $availability['status']->canUpdateBookings())
                                                        ...
                                                        <a href="/dinner/dinner-bookings/{{ $bookingId }}/edit"
                                                            ...
                                                            @class([
                                                                'px-2 py-1 rounded text-xs font-semibold border flex items-center my-2 hover:shadow-md transition-all',
