...
<head>
    ...
    <title>DinnerTable - Organizza le Cene del Tuo Gruppo con Facilità</title>
    <meta name="description" content="DinnerTable è la piattaforma che semplifica l'organizzazione delle cene di gruppo. Coordina i turni, gestisci le disponibilità e condividi momenti conviviali con il tuo team.">
...
<body class="bg-linear-to-br from-amber-50 via-orange-50 to-lime-50 min-h-screen">
    ...
    <main>
        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div class="text-center">
                <div class="flex justify-center mb-10">
                    <img src="{{ asset('images/logo.png') }}" alt="DinnerTable - Organizza Cene di Gruppo" class="h-48 w-auto drop-shadow-lg">
                </div>
        ...
        <section id="features" class="bg-gradient-to-br from-gray-50 to-gray-100 py-24">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
    ...
    <footer class="bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
