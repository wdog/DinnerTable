...
<body class="bg-white antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center gap-8">
                    ...
                    <a href="#features"
                        class="text-gray-600 hover:text-lime-600 transition font-medium">Funzionalità</a>
                    <a href="#testimonials"
                        class="text-gray-600 hover:text-lime-600 transition font-medium">Testimonianze</a>
                        <a href="#contacts"
                        class="text-gray-600 hover:text-lime-600 transition font-medium">Contatti</a>
                </div>
    ...
    <main class="snap-y snap-mandatory overflow-y-scroll h-screen" style="scroll-padding-top: 5rem;">
        <!-- Hero Section -->
        <section id="hero"
            class="snap-start snap-always relative min-h-screen h-auto flex flex-col justify-center pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-lime-50 via-white to-emerald-50 overflow-hidden">
            <!-- Decorative Elements -->
            <div
        ...
        <!-- Benefits Section -->
        <section id="benefits"
            class="snap-start snap-always relative min-h-screen h-auto flex flex-col justify-center pt-2 pb-16 px-4 sm:px-6 lg:px-8 bg-white">
            <div class="max-w-7xl mx-auto">
                <div class="text-center mb-16">
                    <span
                        class="inline-block text-lime-600 font-semibold text-sm uppercase tracking-wider mb-3">Vantaggi</span>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <!-- Benefit 1 -->
                    <div
                        class="group relative bg-linear-to-br from-lime-50 to-emerald-50 p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-lime-100 hover:border-lime-300">
                        <div
                            class="absolute top-4 right-4 w-12 h-12 bg-lime-200 rounded-full opacity-20 group-hover:scale-150 transition-transform duration-500">
                        </div>
                        <div class="relative">
                            <div
                                class="bg-lime-100 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-4">
                                Basta perdere ore in chat infinite per capire chi può ospitare. Visualizza tutte le
                                disponibilità in un calendario intelligente e prenota in un click.
                            </p>
                            <div
                    ...
                    <div
                        class="group relative bg-linear-to-br from-lime-50 to-emerald-50 p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-lime-100 hover:border-lime-300">
                        <div
                            class="absolute top-4 right-4 w-12 h-12 bg-emerald-200 rounded-full opacity-20 group-hover:scale-150 transition-transform duration-500">
                        </div>
                        <div class="relative">
                            <div
                                class="bg-emerald-100 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-4">
                                Il sistema gestisce automaticamente prenotazioni, previene sovrapposizioni e ti notifica
                                quando è il tuo turno. Tu pensa solo al menu!
                            </p>
                            <div
                                class="flex items-center text-emerald-600 font-semibold text-sm group-hover:gap-2 transition-all">
                                <span>Scopri di più</span>
                                <svg class="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div
                        ...
                        <div class="relative">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-4">
                                Le cene regolari creano tradizioni e ricordi indimenticabili. Mantieni viva la socialità
                                del gruppo senza il peso della burocrazia.
                            </p>
                            <div
                                class="flex items-center text-lime-600 font-semibold text-sm group-hover:gap-2 transition-all">
                                <span>Scopri di più</span>
        ...
        <!-- Features Section -->
        <section id="features"
            class="snap-start snap-always relative min-h-screen h-auto flex flex-col justify-center pt-2 pb-16 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-lime-50 via-white to-emerald-50">
            <div class="max-w-7xl mx-auto">
                <div class="text-center mb-16">
                    <span class="inline-block text-lime-600 font-semibold text-sm uppercase tracking-wider mb-3">Come
                        Funziona</span>
                    <h2 class="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
                        Semplice Come 1, 2, 3
                    </h2>
                ...
                <div class="grid md:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <div class="relative group">
                        <div
                            class="absolute -top-6 -left-6 w-16 h-16 bg-lime-500 text-white rounded-2xl flex items-center justify-center text-3xl font-bold shadow-xl z-10 group-hover:scale-110 transition-transform duration-300">
                            1
                        </div>
                        <div
                            class="relative bg-white p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 h-full border-2 border-transparent hover:border-lime-200">
                            <div
                                class="bg-linear-to-br from-lime-100 to-emerald-100 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-4 text-center">
                                Registrati in 30 secondi e crea un nuovo gruppo. Oppure unisciti a uno esistente con il
                                codice di invito.
                            </p>
                            <div class="bg-lime-50 rounded-xl p-4 border border-lime-200">
                                <p class="text-sm text-gray-700 italic text-center">
                                    <svg class="w-4 h-4 inline text-lime-600" fill="currentColor"
                                        viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                    ...
                    <div class="relative group">
                        <div
                            class="absolute -top-6 -left-6 w-16 h-16 bg-emerald-500 text-white rounded-2xl flex items-center justify-center text-3xl font-bold shadow-xl z-10 group-hover:scale-110 transition-transform duration-300">
                            2
                        </div>
                        <div
                            class="relative bg-white p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 h-full border-2 border-transparent hover:border-emerald-200">
                            <div
                                class="bg-linear-to-br from-emerald-100 to-lime-100 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-4 text-center">
                                Visualizza il calendario e indica quando puoi ospitare. Scegli data, orario e numero di
                                ospiti.
                            </p>
                            <div class="bg-emerald-50 rounded-xl p-4 border border-emerald-200">
                                <p class="text-sm text-gray-700 italic text-center">
                                    <svg class="w-4 h-4 inline text-emerald-600" fill="currentColor"
                                        viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                                            clip-rule="evenodd" />
                    ...
                    <div class="relative group">
                        ...
                        <div
                            ...
                            <p class="text-gray-600 leading-relaxed mb-4 text-center">
                                Esplora le disponibilità del gruppo e prenota il tuo posto con un click. Ricevi
        ...
        <section id="testimonials"
            ...
            <div class="max-w-7xl mx-auto">
                <div class="text-center mb-16">
                    <span
                        class="inline-block text-lime-600 font-semibold text-sm uppercase tracking-wider mb-3">Testimonianze</span>
                    <h2 class="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <!-- Testimonial 1 -->
                    <div
                        class="bg-linear-to-br from-lime-50 to-white p-8 rounded-3xl shadow-lg border border-lime-100">
                        ...
                        <p class="text-gray-700 leading-relaxed mb-6 italic">
                            "Finalmente niente più caos su WhatsApp! Con DinnerTable organizziamo le nostre cene
                            settimanali in 5 minuti. Fantastico!"
                        </p>
                        <div class="flex items-center gap-4">
                            <div
                                class="w-12 h-12 rounded-full bg-linear-to-br from-lime-400 to-emerald-400 flex items-center justify-center text-white font-bold text-lg">
                                MC
                            </div>
                            <div>
                    ...
                    <!-- Testimonial 2 -->
                    <div
                        class="bg-linear-to-br from-emerald-50 to-white p-8 rounded-3xl shadow-lg border border-emerald-100">
                        <div class="flex gap-1 mb-4">
                        ...
                        <p class="text-gray-700 leading-relaxed mb-6 italic">
                            "Semplicissimo da usare! Il nostro gruppo di 8 amici non può più farne a meno. Le notifiche
                            automatiche sono comodissime."
                        </p>
                        <div class="flex items-center gap-4">
                            <div
                                class="w-12 h-12 rounded-full bg-linear-to-br from-emerald-400 to-lime-400 flex items-center justify-center text-white font-bold text-lg">
                                GR
                            </div>
                            <div>
                    ...
                    <div
                        ...
                        <p class="text-gray-700 leading-relaxed mb-6 italic">
                            "Perfetto per il nostro team aziendale! Ora le cene mensali sono sempre ben organizzate e
        ...
        <!-- CTA Section -->
        <section id="cta"
            class="snap-start snap-always relative min-h-screen h-auto flex flex-col justify-center pt-2 pb-16 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-lime-500 via-lime-400 to-emerald-400 overflow-hidden">
            <!-- Decorative Elements -->
        ...
        <!-- Sezione Contatti -->
        <section id="contacts"
            class="snap-start snap-always bg-gray-900 text-white min-h-screen h-auto flex items-center pt-2 pb-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid md:grid-cols-4 gap-10 mb-12">
                    <div class="md:col-span-2">
                        ...
                        <div class="flex gap-4">
                            <a href="#"
                                class="w-10 h-10 rounded-full bg-gray-800 hover:bg-lime-500 flex items-center justify-center transition-colors">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            ...
                            <li><a href="/dinner/register"
                                    class="text-lime-400 hover:text-lime-300 transition font-semibold">Registrati
                                    Gratis</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="/dinner" class="text-gray-400 hover:text-lime-400 transition">Pannello
                                    Utente</a></li>
