...
class DinnerCancelledByHostNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line('**Host:** ' . $host->nome . ' ' . $host->cognome)
            ->line('**Motivo:** ' . $reason)
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'message'             => 'La cena del ' . $formattedDate . ' è stata cancellata dall\'host.',
            'availability_id'     => $this->availability->id,
            'booking_id'          => $this->booking->id,
            'dinner_date'         => $dinnerDate,
            'host_name'           => $this->availability->user->nome . ' ' . $this->availability->user->cognome,
